...
@section('body')
    ...
    <div class="col-12 card">
        <img src={{ url('public/images/welcome_page/black_bg.jpg') }} alt="Responsive image" style="width:100%;" class="card-img position-absolute opacity-50">
        <img src={{ url('public/images/welcome_page/welcome_bg.jpeg') }} alt="Responsive image" style="width:100%;" class="card-img">
